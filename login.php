...
<style>
    body,
.signin {
  background: url(images/keyboard-buttons-letters-1600x1200.jpg);
...
<div class="login">
  ...
  <h2 class="active">sign in</h2><h2><a class="active"href="index.php">lapang</a></h2> 
  
   
    

    <input type="text" class="text" name="namauser">
    ...
    <input type="password" class="text" name="kunci">
    <span>password</span>
    <br>
    <input type="submit" class="signin" onclick="contoh()" value="submit">
    <!-- <center><h2><strong><a href="index.html">LAPANG</a></strong></h2></center> -->
    <center><h2><strong><a href="Registrate.php">Register</a></strong></h2></center>
  </form>
